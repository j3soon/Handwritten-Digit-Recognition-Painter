...
set_property IOSTANDARD LVCMOS33 [get_ports rastSW]
...
set_property IOSTANDARD LVCMOS33 [get_ports {themeSW[1]}]
set_property IOSTANDARD LVCMOS33 [get_ports {themeSW[0]}]
