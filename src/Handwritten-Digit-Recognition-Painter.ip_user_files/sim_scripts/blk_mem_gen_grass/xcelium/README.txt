...
#
# Generated by export_simulation on Thu Jan 10 22:44:46 +0800 2019
#
################################################################################
...
'-reset_run' switch to the './blk_mem_gen_grass.sh' script.

./blk_mem_gen_grass.sh -reset_run
...
./blk_mem_gen_grass.sh -noclean_files

For more information on the script, please type './blk_mem_gen_grass.sh -help'.
