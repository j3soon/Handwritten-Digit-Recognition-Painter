...
#
# Generated by export_simulation on Fri Jan 11 11:51:37 +0800 2019
#
################################################################################
...
'-reset_run' switch to the './blk_mem_gen_normalpen.sh' script.

./blk_mem_gen_normalpen.sh -reset_run
...
./blk_mem_gen_normalpen.sh -noclean_files

For more information on the script, please type './blk_mem_gen_normalpen.sh -help'.
