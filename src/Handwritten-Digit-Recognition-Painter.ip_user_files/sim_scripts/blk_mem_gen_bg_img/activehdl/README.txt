...
#
# Generated by export_simulation on Thu Jan 10 22:41:12 +0800 2019
#
################################################################################
...
'-reset_run' switch to the './blk_mem_gen_bg_img.sh' script.

./blk_mem_gen_bg_img.sh -reset_run
...
./blk_mem_gen_bg_img.sh -noclean_files

For more information on the script, please type './blk_mem_gen_bg_img.sh -help'.
