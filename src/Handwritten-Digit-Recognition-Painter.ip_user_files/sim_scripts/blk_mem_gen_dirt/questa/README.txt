...
#
# Generated by export_simulation on Thu Jan 10 22:41:40 +0800 2019
#
################################################################################
...
'-reset_run' switch to the './blk_mem_gen_dirt.sh' script.

./blk_mem_gen_dirt.sh -reset_run
...
./blk_mem_gen_dirt.sh -noclean_files

For more information on the script, please type './blk_mem_gen_dirt.sh -help'.
