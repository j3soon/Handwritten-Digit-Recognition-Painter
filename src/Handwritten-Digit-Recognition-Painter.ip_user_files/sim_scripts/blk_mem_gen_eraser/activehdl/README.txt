...
#
# Generated by export_simulation on Fri Jan 11 00:15:25 +0800 2019
#
################################################################################
...
'-reset_run' switch to the './blk_mem_gen_eraser.sh' script.

./blk_mem_gen_eraser.sh -reset_run
...
./blk_mem_gen_eraser.sh -noclean_files

For more information on the script, please type './blk_mem_gen_eraser.sh -help'.
